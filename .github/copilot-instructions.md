# Spine IQ Assessment Tool - Copilot Instructions

## Architecture Overview

This is a full-stack medical assessment application with a React/TypeScript frontend and Node.js/Express backend for spinal condition evaluations.
